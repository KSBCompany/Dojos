    ...
    class Measurement
    {
        ...
        public void start()
        {
            ...
            (
                ...
                (n) =>
                {
                    Console.WriteLine("Processor1: Maybe Read Gantner Buffer.");
            ...
            (
                ...
                (s) =>
                {
                    Console.WriteLine("Processor2: Data Transformation");
            ...
            (
                ...
                (s) =>
                {
                    Console.WriteLine("Processor3: Send to kafka");
                    Console.WriteLine("The final result is {0}", s);
                },
                cts.Token,
                "filter3"
             );
